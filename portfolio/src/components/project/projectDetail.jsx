...
const ProjectDetail = () => {
  ...
  return (
    <div className="bg-[rgb(241,239,236)] ">
      <div className="w-[80vw] sm:w-[600px] xl:w-[800px] bg-[rgb(27,38,59)] h-[90vh] mx-auto my-[3%] rounded-xl shadow-2xl flex flex-col justify-between border border-none">
        <div className="border-b-2 border-[rgb(177,177,177)] h-20 flex px-3 items-center">
          <img src={Arrow} className="w-10 h-10" />
          <div className="text-center flex-1 text-white ">제목</div>
        </div>
